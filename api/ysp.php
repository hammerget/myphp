...
$n = [
    //央视
    'cctv4k' => 2000266302,//cccv-4k
    'cctv8k' => 2020603421,//cccv-8k
    'cctv1' => 2000210103,//cccv1
    'cctv2' => 2000203602,//cccv2
...
//备用：hlslive-hs-cdn.ysp.cctv.cn
$m3u8 = preg_replace("/{$host}/","hlslive-ty-cdn.ysp.cctv.cn",$live);
$m3u8 = preg_replace("/https/","http",$m3u8);
$burl = dirname($m3u8)."/";
$d = file_get_contents(trim($m3u8));
